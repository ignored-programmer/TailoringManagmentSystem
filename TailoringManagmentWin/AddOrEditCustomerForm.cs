...
{
    public partial class AddOrEditCustomerForm : Form
    {
        public int customerId = 0;
        UnitOfWork db = new UnitOfWork();
        public AddOrEditCustomerForm()
        {
            InitializeComponent();
        }

        private void AddOrEditCustomerForm_Load(object sender, EventArgs e)
        {
            if (customerId != 0)
            {
                this.Text = "سیستم مدیریت خیاطی |ویرایش مشتری";
